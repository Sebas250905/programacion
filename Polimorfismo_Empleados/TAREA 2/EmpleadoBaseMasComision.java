public class EmpleadoBaseMasComision extends EmpleadoPorComision
{
	...
	public double obtenerMontoPago(){
		return obtenerSalarioBase() + super.obtenerMontoPago(); // explicar el problema de recursividad infinita,
	...
	@Override
  	...
  	{
  		return String.format("Empleado Base mas comision: %s%n%s%n%s: %.2f", super.toString(), 
